...
/// 工具定义（内部使用）
/// </summary>
public class PluginToolDefinition
{
    /// <summary>
    /// 工具名称
    /// </summary>
    ...
    /// 参数列表
    /// </summary>
    public List<PluginToolParameterInfo> Parameters { get; set; } = new();
    /// <summary>
    /// 工具所属的类名（用于显示）
    /// </summary>
    public string ClassName => TargetType?.Name ?? "Unknown";
    /// <summary>
    /// 参数摘要（用于快速显示）
    /// </summary>
...
/// 工具参数信息
/// </summary>
public class PluginToolParameterInfo
{
    /// <summary>
    /// 参数名称
    /// </summary>
...
/// 工具使用统计
/// </summary>
public class PluginToolStatistics
{
    /// <summary>
    /// 工具名称
    /// </summary>
